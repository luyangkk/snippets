...
package com.taobao.wireless.turbo.file;
...
public final class Varint {
     ...
     *     terminate after 9 bytes have been read
     * @see #writeSignedVarLong(long, DataOutput)
     */
	public static long readSignedVarLong(DataInput in) throws IOException {
		 ...
		 * treating negative results from read unsigned methods as like 
		 * unsigned values Must re-flip the top bit if the original read 
		 * value had it set. */
